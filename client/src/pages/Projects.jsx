...
export default function LabPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] text-cyan-300 font-mono p-6">
      <h1 className="text-2xl mt-20 mb-4 flex items-center gap-2">
        <HiTerminal /> LAB FILESYSTEM
      </h1>

      <div className="grid md:grid-cols-2 gap-6">
        {/* filesystem */}
        <div className="border bg-black/40 border-cyan-500/30 rounded p-4">
